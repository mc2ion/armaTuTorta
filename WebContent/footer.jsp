<div id="footer">
	...
	<div class="social">
		...
		<a href="http://www.twitter.com/armatutorta" target="_blank"><img class="instagram" src="./images/instagram_social2.png" alt="Instagram" title="Nuestra cuenta en Instagram"/></a>
