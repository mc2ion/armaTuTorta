 ...
 */
@WebServlet(description = "servlet to log in users", urlPatterns = { "/GaleriaTortasServlet" })
public class GaleriaTortasServlet extends HttpServlet {
