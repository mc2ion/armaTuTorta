...
<body oncontextmenu="return inhabilitar()">
	<div id="container">
		...
		<div id="content">
	        	...
	        	<p>&nbsp;</p>
           		<p>&nbsp;</p>
				<form action="/servlet/servlet.EditAlbumServlet?albumId=<%= request.getAttribute("albumId") %>" onsubmit="return validateEditAlbum(this)" method="post" enctype="multipart/form-data">
