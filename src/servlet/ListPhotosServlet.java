 ...
 */
@WebServlet(description = "servlet to list photos of an album", urlPatterns = { "/ListPhotosServlet" })
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if(user != null){
				...
				RequestDispatcher rd = getServletContext().getRequestDispatcher("/admin/photos.jsp");
